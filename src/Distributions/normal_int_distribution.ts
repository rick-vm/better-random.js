...
export default function(min: number, max: number, { inclusiveEnd = false, inclusiveStart = true, standard_deviation = 1 }: DistOptions & NormalOptions = { inclusiveEnd: false, inclusiveStart: true, standard_deviation: 1 }): (rng: random_engine_base) => number {
